...
story_tree <- if (params$include_ai) {
  generate_plot_story(p_tree, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}
...
story_trend <- if (params$include_ai) {
  generate_plot_story(p_trend, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}

p_abs <- plot_reg_population_type_abs(year = params$year, region = params$region, pop_type = "REF")
story_abs <- if (params$include_ai) {
  generate_plot_story(p_abs, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}

p_share <- plot_reg_share(year = params$year, region = params$region, pop_type = "REF")
story_share <- if (params$include_ai) {
  generate_plot_story(p_share, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}

p_increase <- plot_reg_increase(year = params$year, region = params$region, pop_type = c("REF", "ASY", "OIP"))
story_increase <- if (params$include_ai) {
  generate_plot_story(p_increase, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}

p_decrease <- plot_reg_decrease(year = params$year, region = params$region, pop_type = c("REF", "ASY", "OIP"))
story_decrease <- if (params$include_ai) {
  generate_plot_story(p_decrease, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}
...
story_map <- if (params$include_ai) {
  generate_plot_story(p_map, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}
...
story_prop <- if (params$include_ai) {
  generate_plot_story(p_prop, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}
...
story_rsd <- if (params$include_ai) {
  generate_plot_story(p_rsd, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}
...
story_sol <- if (params$include_ai) {
  generate_plot_story(p_sol, provider = params$gp_provider, model = params$gp_model, max_tokens = 200)
} else {
  ""
}
